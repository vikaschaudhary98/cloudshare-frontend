  ...
  useEffect(() => {
    const fetchUserCredits2 = async () => {
      try {
        ...
        setMessage(
          "Failed to load your current credits . please try again later:",
        );
    ...
    <DashboardLayout activeMenu="Subscriptions">
      <div className="p-6">
               ...
               onClick={()=>handlePurchase(plan)}
                ...
                className={`w-full py-2 rounded-md font-medium transition-colors ${
                  plan.recommended
                    ...
                    : "bg-white border border-purple-500 text-purple-500 hover:bg-amber-600"
        ...
        <div className="mt-8 bg-gray-50 p-4 rounded-lg border border-gray-200">
          <h3 className="font-medium mb-2 ">How credits</h3>
          <p className="text-sm text-gray-600">
            Each file upload consumes 1 credits . New user star with 5 free
            credits. Credits never expire and can be used at any time . If you
            run out of credits , you can purchase more through one of our files
            above.
          </p>
        </div>
      </div>
